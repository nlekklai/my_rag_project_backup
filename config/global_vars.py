...
TARGET_SCORE_THRESHOLD_MAP: Final[Dict[int, int]] = {
    1: 2,   # L1-L2: พื้นฐาน (P หรือ P+D)
    2: 2,
    3: 4,   # L3: ต้องมีอย่างน้อย P + D + C
    4: 6,   # L4: ต้องมี P + D + C + A
    5: 8,   # L5: เต็มทุกมิติ
}
...
BASE_PDCA_KEYWORDS: Final[Dict[str, List[str]]] = {
    "Plan": [
        ...
        r"เป้าหมาย", r"ทิศทางองค์กร", r"ประกาศ", r"หลักเกณฑ์", r"เกณฑ์",
        r"master plan", r"roadmap", r"policy", r"การอนุมัติหลักการ",
        r"คำสั่งแต่งตั้ง", r"โครงสร้างการบริหาร", r"วัตถุประสงค์", r"แนวทางการดำเนินงาน",
        r"งบประมาณ", r"กรอบแนวทาง"
    ],
    "Do": [
        r"การดำเนินงาน", r"การปฏิบัติ", r"การจัดทำ", r"การฝึกอบรม", r"ดำเนินการ",
        r"การประชุม", r"บันทึกข้อความ", r"จัดกิจกรรม", r"workshop", 
        r"cop", r"community of practice", r"การถ่ายทอด", r"สื่อสาร", 
        r"ประชาสัมพันธ์", r"การนำไปใช้", r"action plan", r"ขับเคลื่อน", 
        r"คณะทำงาน", r"ภาพถ่ายกิจกรรม", r"คู่มือปฏิบัติงาน", r"ขั้นตอนการ",
        r"ผู้รับผิดชอบ", r"การลงพื้นที่"
    ],
    "Check": [
        r"การวัดผล", r"kpi", r"การประเมิน", r"รายงานผล", r"ตรวจสอบ",
        r"ติดตามผล", r"วิเคราะห์", r"ช่องว่าง", r"audit", r"review",
        r"dashboard", r"ผลลัพธ์", r"ตัวชี้วัด", r"สรุปผล", r"gap analysis",
        r"evaluation", r"performance", r"ความพึงพอใจ", r"แบบสอบถาม", r"สถิติการใช้งาน",
        r"ผลการดำเนินงาน", r"ความก้าวหน้า", r"เปรียบเทียบกับเป้าหมาย", r"บรรลุเป้าหมาย",
        # --- เพิ่มคำเฉพาะทางการของ PEA ---
        r"สรุปผลการดำเนินงาน", r"รายงานความก้าวหน้า", r"ผลงานตามตัวชี้วัด",
        r"คะแนนการประเมิน", r"ผลสำเร็จ", r"ไตรมาสที่", r"รายงานประจำปี",
        r"สถานะการดำเนินงาน", r"รายงานการติดตาม", r"บันทึกการประชุมคณะทำงาน"
    ],
    "Act": [
        ...
        r"ความยั่งยืน", r"sustainability", r"มาตรฐานใหม่", r"การนำผลประเมินมาปรับปรุง",
        r"ถอดบทเรียน", r"ความคุ้มค่า", r"re-design", r"self-assessment", r"จุดแข็งจุดอ่อน",
        # --- เพิ่มคำที่เกี่ยวกับการนำผลไปใช้ต่อ ---
        r"ข้อเสนอแนะจากการประเมิน", r"การนำไปปรับปรุง", r"แนวทางการพัฒนาต่อยอด",
        r"แผนการปรับปรุง", r"การจัดการข้อเสนอแนะ", r"การเปลี่ยนแปลงกระบวนงาน"
    ],
}

PDCA_LEVEL_SYNONYMS: Final[Dict[int, str]] = {
    1: "นโยบาย, แผนแม่บท, ยุทธศาสตร์, วิสัยทัศน์, การกำหนดเป้าหมาย, ผู้บริหารระดับสูง, การมอบนโยบาย, การอนุมัติแผนงาน, กรอบแนวทาง, ทิศทางองค์กร",
    
    2: "คณะทำงาน, โครงสร้างองค์กร, การขับเคลื่อน, การดำเนินการ, ความรับผิดชอบ, แผนปฏิบัติการ, การสื่อสารนโยบาย, การอบรม, กิจกรรม, การนำไปปฏิบัติ, ผู้รับผิดชอบหลัก",
    
    3: "การวัดผล, การประเมินผล, KPI, รายงานผลการดำเนินงาน, สรุปผลไตรมาส, การตรวจสอบ, การทบทวน, การติดตามผล, ช่องว่าง (Gap), บรรลุเป้าหมาย, ผลสัมฤทธิ์, ดัชนีชี้วัด, รายงานความก้าวหน้า",
    
    4: "การปรับปรุง, Corrective Action, บทเรียนที่ได้รับ, การแก้ไข, ปรับแผน, การสร้างนวัตกรรม, การจัดการข้อเสนอแนะ, ถอดบทเรียน, แนวทางพัฒนา, การป้องกันข้อผิดพลาดซ้ำ, ปรับปรุงกระบวนงาน",
    
    5: "นวัตกรรม, ความยั่งยืน, Best Practice, การขยายผล, ผลกระทบระยะยาว, รางวัล, External Recognition, มาตรฐานใหม่, ต้นแบบ, การถ่ายทอดความรู้สู่ภายนอก, วัฒนธรรมองค์กร"
}
