...
BASE_PDCA_KEYWORDS: Final[Dict[str, List[str]]] = {
    "Plan": [
        r"นโยบาย", r"แผน", r"กลยุทธ์", r"กรอบแนวทาง", r"วิสัยทัศน์",
        r"เป้าหมาย", r"กำหนด", r"ยุทธศาสตร์", r"แผนแม่บท",
        r"master plan", r"roadmap", r"กำหนดทิศทาง",
    ],
    "Do": [
        r"การดำเนินงาน", r"การจัดทำ", r"การฝึกอบรม", r"การปฏิบัติ",
        r"ระบบ", r"ดำเนินการ", r"จัดกิจกรรม", r"แต่งตั้ง",
        r"คณะทำงาน", r"ถ่ายทอด", r"action plan", r"ขับเคลื่อน",
        r"จัดตั้ง",
    ],
    "Check": [
        r"การวัดผล", r"kpi", r"การประเมิน", r"รายงานผล",
        r"การวิเคราะห์ช่องว่าง", r"ตรวจสอบ", r"ผลลัพธ์",
        r"ติดตาม", r"ตัวชี้วัด", r"audit", r"review",
        r"ประเมินผล", r"ความคืบหน้า", r"ปัญหาและอุปสรรค",
        r"dashboard", r"real-time monitoring", r"analytics",
    ],
    "Act": [
        r"การปรับปรุง", r"การแก้ไข", r"บทเรียนที่ได้รับ",
        r"corrective action", r"เปลี่ยนแปลงวิธีการ", r"มาตรการ",
        r"ปรับปรุงอย่างต่อเนื่อง", r"lesson learned",
        r"นำมาปรับปรุง", r"ข้อเสนอแนะ", r"แนวทางแก้ไข",
        r"นวัตกรรม", r"digital transformation",
        r"ความยั่งยืน", r"sustainability", r"esg",
    ],
}
