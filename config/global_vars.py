...
BASE_PDCA_KEYWORDS: Final[Dict[str, List[str]]] = {
    ...
    "Check": [
        # เพิ่มคำทางการที่ใช้ในรายงานสรุปผลของ PEA
    ...
    "Act": [
        # เพิ่มคำที่เกี่ยวกับการนำผลประเมินมาพัฒนาต่อ
...
PDCA_LEVEL_SYNONYMS: Final[Dict[int, str]] = {
    ...
    2: "คณะทำงาน, โครงสร้างองค์กร, การขับเคลื่อน, การดำเนินการ, ความรับผิดชอบ, แผนปฏิบัติการ, การสื่อสารนโยบาย, การอบรม, กิจกรรม",
    3: "การวัดผล, การประเมินผล, KPI, รายงานผลการดำเนินงาน, สรุปผลไตรมาส, การตรวจสอบ, การทบทวน, การติดตามผล, ช่องว่าง (Gap), บรรลุเป้าหมาย",
    4: "การปรับปรุง, Corrective Action, บทเรียนที่ได้รับ, การแก้ไข, ปรับแผน, การสร้างนวัตกรรม, การจัดการข้อเสนอแนะ, ถอดบทเรียน, แนวทางพัฒนา",
    5: "นวัตกรรม, ความยั่งยืน, Best Practice, การขยายผล, ผลกระทบระยะยาว, รางวัล, External Recognition, มาตรฐานใหม่"
}
