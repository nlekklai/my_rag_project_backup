...
2. หากข้อมูลใน Context ไม่เพียงพอหรือไม่มีความเกี่ยวข้อง ให้ระบุว่า "ข้อมูลในเอกสารที่ให้มาไม่เพียงพอต่อการตอบคำถาม"
3. สรุปคำตอบเป็น **ภาษาไทยกระชับ ชัดเจน และตรงประเด็น**
4. หากเหมาะสม ให้จัดรูปแบบคำตอบด้วยหัวข้อย่อยหรือตาราง
"""
