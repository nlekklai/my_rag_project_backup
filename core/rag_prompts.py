...
ให้เป็นแผนปฏิบัติการ (Action Plan) ที่มีโครงสร้างและสามารถนำไปใช้ได้จริง
...
5. ระบุประเภทหลักฐาน (Target_Evidence_Type) และตัวชี้วัดสำเร็จ (Key_Metric)
...
2. Action ต้องเฉพาะเจาะจงและสอดคล้องกับ Root Cause ที่ระบุไว้
3. ระบุ Target_Evidence_Type และ Key_Metric ให้ครบถ้วน
4. ห้ามใช้คำทั่วไป เช่น “จัดทำเอกสาร” หรือ “ดำเนินการปรับปรุง” ต้องบอกชัดว่าทำอะไร ปรับอะไร ที่ส่วนใด
5. หากมี SEAM Reference Context ให้ใช้เป็นข้อมูลอ้างอิงสำหรับแนวทางการปรับปรุง
