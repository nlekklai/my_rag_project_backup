...
3. **ถ้า Extraction_C มีเนื้อหาชัดเจน (มากกว่า 10 คำ) → C_Check_Score ต้องเป็น 1 หรือ 2**
4. **ถ้า Extraction_A มีเนื้อหาชัดเจน (มากกว่า 10 คำ) → A_Act_Score ต้องเป็น 1 หรือ 2**
5. ค่า "score" ต้องเป็นผลรวมของ P_Plan_Score + D_Do_Score + C_Check_Score + A_Act_Score เท่านั้น
